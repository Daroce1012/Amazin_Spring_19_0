...
public interface CartManagerService {
    ...
    void removeItemFromCart(String username, Cart cart, int bookId, boolean isReserved) throws Exception;
    void clearCart(String username, Cart cart) throws Exception;
    void purchaseItem(String username, Cart cart, int bookId, boolean isReserved) throws Exception;
